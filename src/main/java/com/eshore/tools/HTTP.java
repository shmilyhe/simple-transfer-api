...
public class HTTP {
	...
	static String USER_AGENT = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/54.0.2840.71 Safari/537.36";
	...
	public HttpEntity doGet(String url, List<BasicNameValuePair> params, boolean redirect,
		...
		try {
			...
			httpGet.setHeader("User-Agent", HTTP.USER_AGENT);
			if (headerMap != null) {
